...
<%--        年级：<input type="text" name="stu.grade" value="<s:property value="grade"/>"><br>--%>
        工作专业：<input type="text" name="stu.major" value="<s:property value="major"/>"><br>
        工作水平：<input type="text" name="stu.joblevel" value="<s:property value="joblevel"/>"><br>
        工资：<input type="text" name="stu.salary" value="<s:property value="salary"/>"><br>
